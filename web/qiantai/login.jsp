...
<head>
    ...
    <script>
        function getCode(){
            //得到呈现验证码图片的对象，让该对象重新发请求
            var img = document.getElementById("validateImg");
            //在正常情况下，还是会有缓存的影响,应该要让每次的请求的url不相同
            ...
            <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img id="validateImg" src="UserSvl?reqType=validate" width="90" height="20" style="position: relative;top:7px;"/>
                        <input type="button" name="validateCode" value="看不清" onclick="getCode()"/>
                        ${info}
                    </td>
                </tr>
                <tr>
